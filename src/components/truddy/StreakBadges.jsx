        ...
        return (
          <motion.div
            ...
            <div className="relative">
              <div className="bg-slate-50 text-slate-900 rounded-[12px] w-10 h-10 grid place-items-center"
              style={{ background: count > 0 ? s.bg : "rgba(var(--glass),0.28)", border: `1px solid ${count > 0 ? s.border : "rgba(255,255,255,0.18)"}` }}>
                <s.Icon size={18} style={{ color: count > 0 ? s.iconColor : "rgba(var(--muted),0.3)" }} className="bg-slate-50 lucide lucide-book-open" />
              </div>
              {fire &&
              <motion.span
