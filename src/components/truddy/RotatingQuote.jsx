...
export default function RotatingQuote() {
  ...
  return (
    <motion.p
      ...
      transition={{ duration: 0.5, ease: [0.2, 0.8, 0.2, 1] }} className="text-[rgba(var(--muted),0.7)] mt-1 text-xs font-light text-left normal-case leading-snug sm:text-xs max-w-[240px] sm:max-w-[360px]">
