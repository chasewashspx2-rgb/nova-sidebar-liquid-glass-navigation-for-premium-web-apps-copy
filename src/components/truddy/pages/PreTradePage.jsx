...
const GATE_QUESTIONS = [
  ...
  },
  {
    ...
    category: "Emotion",
    question: "Am I entering based on a valid setup, free from FOMO, boredom, or the need to recover losses?",
    yesLabel: "Clear and objective",
    noLabel: "Something feels off",
    weight: 3,
    failWarning: "Emotional trades are the #1 account killer. Step away, reset, and only return when you're objective.",
  },
  {
    id: "risk_accepted",
    category: "Mental",
    question: "Have I truly accepted the risk on this trade — I'm OK if this money is gone?",
    yesLabel: "Fully accepted",
    noLabel: "Not quite",
    weight: 3,
    failWarning: "If you haven't accepted the risk, you'll make fear-based decisions mid-trade. Do not enter.",
  },
  {
    id: "target_defined",
    category: "Risk",
