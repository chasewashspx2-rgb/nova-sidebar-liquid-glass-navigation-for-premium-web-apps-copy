...
import { Brain, Shield, BarChart2, ArrowRight, CheckCircle2, AlertCircle, ShieldCheck, Flame, Sparkles, Pen, Bell } from "lucide-react";
...
export default function TruddyHome({ onNavigate }) {
  ...
  const quickActions = [
    { icon: <Pen size={18} />,         label: "Live Session",   sub: "Real-time trade tracking",  page: "session", accent: true },
    { icon: <YinYangIcon size={18} />, label: "Yin and Yang",   sub: "AI coaching session",       page: "coach" },
    { icon: <PenJournalIcon size={18} />,      label: "Journal Entry",  sub: "Log and reflect on trades", page: "journal" },
