...
import { Bell, ChevronRight, LayoutGrid, Moon, Search, Settings, Sun, X, Brain, BookOpen, Shield, BarChart2, Sparkles, Home, ShieldCheck, MessageCircle, Radio, Users } from "lucide-react";
    ...
    <main className="min-h-screen p-3 sm:p-6 lg:p-10">
      ...
      <MDiv initial={{ opacity: 0, y: 12, scale: 0.995 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.7, ease: [0.2, 0.8, 0.2, 1] }} className="relative mx-auto max-w-[1280px] rounded-[24px] sm:rounded-[32px] lg:rounded-[40px] glass-strong overflow-hidden grain">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-[98px_1fr]">
          {/* Sidebar */}
           <aside className="hidden lg:block relative z-10 px-4 py-6 lg:px-5 lg:py-8" style={{ background: "#faf9f6" }}>
          ...
          {/* Main Content */}
          <section className="bg-[#faf9f6] p-4 sm:p-5 lg:p-7 min-h-[calc(100vh-80px)]">
